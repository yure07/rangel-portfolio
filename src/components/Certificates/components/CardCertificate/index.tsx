  ...
  return(
    <div className="flex flex-col lg:flex-row gap-6 my-8 mx-auto items-center text-center">
      ...
      <div className="flex flex-col gap-2 lg:text-start">
        <h3 className="uppercase text-xl font-black">{certificateProp.title}</h3>
        <p className="text-justify text-xs w-52 lg:w-64 px-2 lg:p-0">{certificateProp.description}</p>
      </div>
    </div>
  )
}